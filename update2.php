...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE bank SET `Fname`='$Fname',`Lname`='$Lname',`PhoneNo`='$PhoneNo',`Email`='$Email',`AccBal`='$AccBal' WHERE  Cust_ID= '2'";
...
<body>
    ...
    <div class = "container" style="color:black;">
        ...
        $sql="SELECT * from bank WHERE Cust_ID = '2'";
        $result=mysqli_query($con,$sql);
        ...
        <div class = "container d-flex justify-content-center">
            <form action ="" method ="post" style="width:50vw; min-width:300px;">
                ...
                <div>
                    ...
                    <a href ="cust2.php" class="btn btn-danger">Cancel</a>
                </div>
